...
class Settings(BaseSettings):
    ...
    asset_storage_root: Path = Field(default=Path(".rag-assets"), alias="ASSET_STORAGE_ROOT")
    asset_max_image_bytes: int = Field(default=15 * 1024 * 1024, alias="ASSET_MAX_IMAGE_BYTES", ge=1)
    asset_max_images_per_document: int = Field(default=100, alias="ASSET_MAX_IMAGES_PER_DOCUMENT", ge=1)
    asset_max_total_bytes_per_document: int = Field(default=100 * 1024 * 1024, alias="ASSET_MAX_TOTAL_BYTES_PER_DOCUMENT", ge=1)
